...
namespace Game
{
    ...
    public partial class EntityParent : NotifyPropChanged,INotifyPropChanged
    {
        ...
        /// <param name="rootRenderNode"></param>
        /// <returns></returns>
        protected int GatherMeshes(GameObject rootRenderNode)
        {
            if (null == rootRenderNode)
            {
                return 0;
            }
            SkinnedMeshRenderer[] skinmesh = rootRenderNode.GetComponentsInChildren<SkinnedMeshRenderer>();
            int i = skinmesh.Length;
            foreach (var child in skinmesh)
            {
                meshTable[child.name] = child.gameObject;
            }
            MeshRenderer[] staticmesh = rootRenderNode.GetComponentsInChildren<MeshRenderer>();
            i += staticmesh.Length;
        ...
        public virtual void CreateActualModel()
        { 

        }
        public virtual void CreateDeafaultModel()
        {
        ...
        public virtual void AddUniqEventListener(string eventType,Action handler)
        {
            EventDispatch.AddEventListener(MakeUniqMessage(eventType), handler);
        }
        public virtual void AddUniqEventListener<T>(string eventType, Action<T> handler)
        {
            EventDispatch.AddEventListener<T>(eventType, handler);
        }
        public virtual void AddUniqEventListener<T,U>(string eventType, Action<T,U> handler)
        {
            EventDispatch.AddEventListener<T,U>(eventType, handler);
        }
        public virtual void AddUniqEventListener<T,U,V>(string eventType, Action<T,U,V> handler)
        {
            EventDispatch.AddEventListener<T,U,V>(eventType, handler);
        }
        public virtual void AddUniqEventListener<T, U, V,W>(string eventType, Action<T, U, V,W> handler)
        {
            EventDispatch.AddEventListener<T, U, V,W>(eventType, handler);
        }
        virtual public void RemoveUniqEventListener(string eventType, Action handler)
        {
            EventDispatch.RemoveEventListener(MakeUniqMessage(eventType), handler);
        }
        public virtual void RemoveUniqEventListener<T>(string eventType, Action<T> handler)
        {
            EventDispatch.RemoveEventListener<T>(eventType, handler);
        }
        public virtual void RemoveUniqEventListener<T,U>(string eventType, Action<T,U> handler)
        {
            EventDispatch.RemoveEventListener<T,U>(eventType, handler);
        }
        public virtual void RemoveUniqEventListener<T,U,V>(string eventType, Action<T,U,V> handler)
        {
            EventDispatch.RemoveEventListener<T,U,V>(eventType, handler);
        }
        public virtual void RemoveUniqEventListener<T, U, V,W>(string eventType, Action<T, U, V,W> handler)
        {
            EventDispatch.RemoveEventListener<T, U, V,W>(eventType, handler);
        }
        ...
        {
            EventDispatch.TriggerEvent<T>(MakeUniqMessage(eventType),arg1);
        }
        ...
        {
            EventDispatch.TriggerEvent<T, U,V>(MakeUniqMessage(eventType), arg1, arg2,arg3);
        }
