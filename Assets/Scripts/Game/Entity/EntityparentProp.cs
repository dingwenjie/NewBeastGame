...
namespace Game
{
    public partial class EntityParent
    {
        ...
        public FSMMotion fsmMotion = new FSMMotion();
        ...
        private Vocation m_vocation = Vocation.Engineer;//职业
        ...
        public Vocation Vocation
        {
            ...
            set 
            {
                this.m_vocation = value;
                //OnPropertyChanged("HeadIcon", HeadIcon);
            }
        }
        public byte Gender
        {
